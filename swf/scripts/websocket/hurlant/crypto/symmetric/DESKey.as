   ...
   public class DESKey implements ISymmetricKey
   {
      ...
      protected function generateWorkingKey(param1:Boolean, param2:ByteArray, param3:uint) : Array
      {
         ...
         while(_loc6_ < 16)
         {
            ...
            while(_loc8_ < 28)
            {
               _loc9_ = uint(_loc8_ + totrot[_loc6_]);
               if(_loc9_ < 28)
               {
      ...
      protected function desFunc(param1:Array, param2:ByteArray, param3:uint, param4:ByteArray, param5:uint) : void
      {
         ...
         var _loc6_:* = 0;
         var _loc10_:* = 0;
         _loc7_ = uint((param2[param3 + 0] & 255) << 24);
         _loc7_ = uint(_loc7_ | (param2[param3 + 1] & 255) << 16);
         _loc7_ = uint(_loc7_ | (param2[param3 + 2] & 255) << 8);
         _loc7_ = uint(_loc7_ | param2[param3 + 3] & 255);
         _loc9_ = uint((param2[param3 + 4] & 255) << 24);
         _loc9_ = uint(_loc9_ | (param2[param3 + 5] & 255) << 16);
         _loc9_ = uint(_loc9_ | (param2[param3 + 6] & 255) << 8);
         _loc9_ = uint(_loc9_ | param2[param3 + 7] & 255);
         _loc8_ = uint((_loc7_ >>> 4 ^ _loc9_) & 252645135);
         _loc9_ = uint(_loc9_ ^ _loc8_);
         _loc7_ = uint(_loc7_ ^ _loc8_ << 4);
         _loc8_ = uint((_loc7_ >>> 16 ^ _loc9_) & 65535);
         _loc9_ = uint(_loc9_ ^ _loc8_);
         _loc7_ = uint(_loc7_ ^ _loc8_ << 16);
         _loc8_ = uint((_loc9_ >>> 2 ^ _loc7_) & 858993459);
         _loc7_ = uint(_loc7_ ^ _loc8_);
         _loc9_ = uint(_loc9_ ^ _loc8_ << 2);
         _loc8_ = uint((_loc9_ >>> 8 ^ _loc7_) & 16711935);
         _loc7_ = uint(_loc7_ ^ _loc8_);
         _loc9_ = uint(_loc9_ ^ _loc8_ << 8);
         _loc9_ = uint((_loc9_ << 1 | _loc9_ >>> 31 & 1) & 4294967295);
         ...
         while(_loc6_ < 8)
         {
            _loc8_ = uint(_loc9_ << 28 | _loc9_ >>> 4);
            _loc8_ = uint(_loc8_ ^ param1[_loc6_ * 4 + 0]);
            _loc10_ = uint(SP7[_loc8_ & 63]);
            _loc10_ = uint(_loc10_ | SP5[_loc8_ >>> 8 & 63]);
            _loc10_ = uint(_loc10_ | SP3[_loc8_ >>> 16 & 63]);
            _loc10_ = uint(_loc10_ | SP1[_loc8_ >>> 24 & 63]);
            _loc8_ = uint(_loc9_ ^ param1[_loc6_ * 4 + 1]);
            _loc10_ = uint(_loc10_ | SP8[_loc8_ & 63]);
            _loc10_ = uint(_loc10_ | SP6[_loc8_ >>> 8 & 63]);
            _loc10_ = uint(_loc10_ | SP4[_loc8_ >>> 16 & 63]);
            _loc10_ = uint(_loc10_ | SP2[_loc8_ >>> 24 & 63]);
            _loc7_ = uint(_loc7_ ^ _loc10_);
            _loc8_ = uint(_loc7_ << 28 | _loc7_ >>> 4);
            _loc8_ = uint(_loc8_ ^ param1[_loc6_ * 4 + 2]);
            _loc10_ = uint(SP7[_loc8_ & 63]);
            _loc10_ = uint(_loc10_ | SP5[_loc8_ >>> 8 & 63]);
            _loc10_ = uint(_loc10_ | SP3[_loc8_ >>> 16 & 63]);
            _loc10_ = uint(_loc10_ | SP1[_loc8_ >>> 24 & 63]);
         ...
         _loc8_ = uint((_loc7_ >>> 8 ^ _loc9_) & 16711935);
         _loc9_ = uint(_loc9_ ^ _loc8_);
         _loc7_ = uint(_loc7_ ^ _loc8_ << 8);
         _loc8_ = uint((_loc7_ >>> 2 ^ _loc9_) & 858993459);
         _loc9_ = uint(_loc9_ ^ _loc8_);
         _loc7_ = uint(_loc7_ ^ _loc8_ << 2);
         _loc8_ = uint((_loc9_ >>> 16 ^ _loc7_) & 65535);
         _loc7_ = uint(_loc7_ ^ _loc8_);
         _loc9_ = uint(_loc9_ ^ _loc8_ << 16);
         _loc8_ = uint((_loc9_ >>> 4 ^ _loc7_) & 252645135);
         _loc7_ = uint(_loc7_ ^ _loc8_);
         _loc9_ = uint(_loc9_ ^ _loc8_ << 4);
