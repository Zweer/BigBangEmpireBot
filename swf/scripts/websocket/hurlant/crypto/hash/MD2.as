   ...
   public class MD2 implements IHash
   {
      ...
      public function hash(param1:ByteArray) : ByteArray
      {
         ...
         while(_loc7_ < _loc2_)
         {
            ...
            while(_loc8_ < 16)
            {
               _loc12_ = param1[_loc7_ + _loc8_];
               _loc5_[16 + _loc8_] = _loc12_;
               _loc5_[32 + _loc8_] = _loc12_ ^ _loc5_[_loc8_];
               _loc8_++;
            }
            _loc3_ = uint(0);
            _loc8_ = uint(0);
            while(_loc8_ < 18)
            {
               ...
               while(_loc9_ < 48)
               {
                  _loc3_ = uint(_loc5_[_loc9_] ^ S[_loc3_]);
                  _loc5_[_loc9_] = _loc5_[_loc9_] ^ S[_loc3_];
                  _loc9_++;
               }
