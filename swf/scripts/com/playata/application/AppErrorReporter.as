      ...
      public function reportError(param1:String, param2:TypedObject = null, param3:Boolean = true, param4:Boolean = true, param5:* = null) : void
      {
         ...
         if(param4 && Application.userController)
         {
            ...
            if(_loc18_ != null)
            {
               ...
               _loc9_ = _loc9_ + ("User Email: " + _loc18_.email + "\n");
               if(_loc18_.character != null)
               {
                  _loc9_ = _loc9_ + ("Character Id: " + _loc18_.character.id + "\n");
                  _loc9_ = _loc9_ + ("Character Name: " + _loc18_.character.name + "\n");
               }
            }
            if(ViewManager.instance != null)
            {
               ...
               if(_loc13_ != null)
               {
                  _loc9_ = _loc9_ + ("Last Dialog: " + _loc13_ + "\n");
               }
            }
            _loc9_ = _loc9_ + "--------------------------------------------\n";
