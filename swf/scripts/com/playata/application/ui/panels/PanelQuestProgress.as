      ...
      override public function refresh() : void
      {
         ...
         if(_durationEvent is Quest)
         {
            if((_durationEvent as Quest).isUserStoryQuest)
            {
               ...
               _loc2_.content.btnInstantFinish.y = _loc2_.content.btnInstantFinish.y + 60;
               _loc2_.content.btnCancel.y = _loc2_.content.btnCancel.y + 60;
               _loc2_.content.y = _loc2_.content.y - 30;
               _loc2_.content.bg.height = _loc2_.content.bg.height + 60;
            }
         }
