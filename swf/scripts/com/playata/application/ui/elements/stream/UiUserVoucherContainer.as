package com.playata.application.ui.elements.stream
{
   ...
   import com.playata.application.ui.list.UserVoucherListFilter;
   ...
   public class UiUserVoucherContainer
   {
      ...
      public function UiUserVoucherContainer(param1:SymbolUserVoucherContainerGeneric)
      {
         ...
         _list.currentFilter = new UserVoucherListFilter();
      ...
      {
         _content.list.txtNoUserVouchers.visible = _userVouchers.length == 0 && _initialized;
      }
