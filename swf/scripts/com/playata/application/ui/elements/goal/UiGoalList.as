   ...
   public class UiGoalList
   {
      ...
      private function refreshList(param1:Boolean = false, param2:Boolean = false) : void
      {
         ...
         else
         {
            ...
            _content.txtCompleted.text = LocText.current.text("dialog/goals/completed_text",_finishedGoal.length,_totalGoalValues,Math.round(_finishedGoal.length / _totalGoalValues * 100));
            _content.txtNoGoals.text = LocText.current.text("dialog/goals/no_goals");
         }
