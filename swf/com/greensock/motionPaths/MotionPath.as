package com.greensock.motionPaths
{
   ...
   public class MotionPath extends Shape
   {
      ...
      public function distribute(param1:Array = null, param2:Number = 0, param3:Number = 1, param4:Boolean = false, param5:Number = 0) : void
      {
         ...
         var _loc8_:Number = _loc7_ > 1?Number((param3 - param2) / (_loc7_ - 1)):1;
         while(--_loc7_ > -1)
         {
      ...
      public function set progress(param1:Number) : void
      {
         if(param1 > 1)
         {
            ...
            param1 = Number(param1 - int(param1));
            if(param1 == 0)
            {
               param1 = 1;
            }
         ...
         {
            this._rawProgress = param1;
            param1 = Number(param1 - (int(param1) - 1));
         }
         else
         {
         ...
         while(_loc3_)
         {
            ...
            _loc3_.cachedRawProgress = _loc3_.cachedRawProgress + _loc2_;
