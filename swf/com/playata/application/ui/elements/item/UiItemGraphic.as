package com.playata.application.ui.elements.item
{
   ...
   public class UiItemGraphic extends Sprite implements IDragSource
   {
      ...
      private var _equippeMissileDamage:int;
      ...
      public function refreshItemCompare() : void
      {
         ...
         updateEquippedStats();
         var _loc2_:int = _equippedCriticalRating + _equippedDodgeRating + _equippedStamina + _equippedStrength + _equippedWeaponDamage + _equippeMissileDamage;
