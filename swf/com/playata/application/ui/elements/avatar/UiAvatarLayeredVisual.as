package com.playata.application.ui.elements.avatar
{
   ...
   public class UiAvatarLayeredVisual implements IAvatarVisual
   {
      ...
      public function UiAvatarLayeredVisual(param1:Sprite, param2:Boolean = false, param3:Boolean = false)
      {
         super();
         _avatar = param1;
         ...
         _avatar.addChild(_behindAvatarAnimation);
         _avatar.addChild(FlashSprite.fromNative(_visualAvatar));
         _avatar.addChild(_infrontAvatarAnimation);
