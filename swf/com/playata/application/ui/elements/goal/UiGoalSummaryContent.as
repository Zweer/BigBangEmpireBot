package com.playata.application.ui.elements.goal
{
   ...
   public class UiGoalSummaryContent
   {
      ...
      public function UiGoalSummaryContent(param1:SymbolGoalSummaryContentGeneric, param2:Character, param3:Function)
      {
         super();
         _content = param1;
         ...
         _line1 = new UiGoalLine(_content.line1,null,null,null);
         _line2 = new UiGoalLine(_content.line2,null,null,null);
      ...
      public function refresh(param1:Character) : void
      {
         ...
         _line1.refresh(param1,_loc2_.length > 0?_loc2_[0]:null,2);
         _line2.refresh(param1,_loc2_.length > 1?_loc2_[1]:null,2);
         _content.txtNoGoals.visible = _loc2_.length <= 0;
         _progressMain.refresh(param1);
         _progressCategory1.refresh(param1);
         _progressCategory2.refresh(param1);
         _progressCategory3.refresh(param1);
         _progressCategory4.refresh(param1);
         _progressCategory5.refresh(param1);
      }
   }
}
