package com.playata.application.ui.elements.citymap
{
   ...
   public class UiCitymapQuestIcon
   {
      ...
      public function UiCitymapQuestIcon(param1:SymbolCitymapIconQuestGeneric, param2:int)
      {
         super();
         _content = param1;
      ...
      public function refresh() : void
      {
         ...
         if(User.current.character.maxQuestStage >= _stage && _loc3_.length > 0)
         {
            _loc5_ = _loc3_[0];
            ...
            else
            {
               ...
               while(_loc2_ < 5)
               {
                  _loc6_ = _loc1_.getChildByName("stat" + _loc2_);
                  _loc6_.visible = _loc2_ == _loc5_.statQuestStat;
                  _loc2_++;
               }
            }
