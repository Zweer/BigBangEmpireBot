package com.playata.application.ui.dialogs
{
   ...
   public class DialogSelectItemForOutfit extends UiDialog
   {
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:SymbolDialogSelectItemForOutfitGeneric = _vo as SymbolDialogSelectItemForOutfitGeneric;
         _btnClose.dispose();
         _btnChange.dispose();
         ...
         while(_loc2_ < 10)
         {
            _itemSlots[_loc2_].dispose();
            _loc3_ = _loc1_.getChildByName("itemSlot" + _loc2_) as SymbolItemSlotGeneric;
            _loc2_++;
         }
         _itemSlots = null;
