package com.playata.application.ui.dialogs
{
   ...
   public class DialogClaimMovieStar extends UiDialog
   {
      ...
      public function DialogClaimMovieStar(param1:Movie, param2:Function)
      {
         ...
         {
            _loc3_.iconStatPoints.y = _loc3_.iconStatPoints.y + (_loc3_.txtXp.y - _loc3_.txtCoins.y);
            _loc3_.iconPremiumCurrency.y = _loc3_.iconPremiumCurrency.y + (_loc3_.txtXp.y - _loc3_.txtCoins.y);
            _loc3_.txtStatPointsPremiumCurrency.y = _loc3_.txtStatPointsPremiumCurrency.y + (_loc3_.txtXp.y - _loc3_.txtCoins.y);
         }
