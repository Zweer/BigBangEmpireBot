package com.playata.application.ui.dialogs
{
   ...
   import com.playata.application.ui.elements.leaderboard.UiLeaderboardCharacterGlobalTournamentContent;
   ...
   public class DialogLeaderboard extends UiDialog
   {
      ...
      private static var _characterGlobalTournamentLeaderboardContext:CharacterGlobalTournamentLeaderboardContext = null;
      ...
      private var _characterGlobalTournamentContent:UiLeaderboardCharacterGlobalTournamentContent = null;
      ...
      private var _btnTabCharacterGlobalTournament:UiTabButton = null;
      ...
      public function DialogLeaderboard()
      {
         ...
         if(!_characterGlobalTournamentLeaderboardContext)
         {
            _characterGlobalTournamentLeaderboardContext = new CharacterGlobalTournamentLeaderboardContext();
         }
         ...
         _characterGlobalTournamentContent = new UiLeaderboardCharacterGlobalTournamentContent(_loc1_.globalTournamentContent,refreshButtons,onClickViewPlayer,_characterGlobalTournamentLeaderboardContext);
         ...
         _btnTabCharacterGlobalTournament = new UiTabButton(_loc1_.btnTabCharacterGlobalTournament,LocText.current.text("dialog/leadboard/button_tab_character_global_tournament"),"",onClickTabCharacterGlobalTournament);
         ...
         _btnTabCharacterGlobalTournament.visible = AppEnvironment.appPlatform.isPlayata;
         ...
         _characterGlobalTournamentContent.refreshCharacterList();
         ...
         switch(int(activeLeaderboard) - 1)
         {
            ...
            case 4:
               ...
               break;
            case 5:
               onClickTabCharacterGlobalTournament(null);
         }
      }
      ...
      public static function reset() : void
      {
         ...
         if(_characterGlobalTournamentLeaderboardContext)
         {
            _characterGlobalTournamentLeaderboardContext.reset();
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         _btnTabMovies = null;
         _btnTabCharacterGlobalTournament.dispose();
         _btnTabCharacterGlobalTournament = null;
         ...
         _movieContent = null;
         _characterGlobalTournamentContent.dispose();
         _characterGlobalTournamentContent = null;
         super.dispose();
      }
      ...
      private function onClickTabCharacters(param1:InteractionEvent) : void
      {
         ...
         _btnTabCharacterGlobalTournament.tabbed = false;
         ...
         _loc2_.globalTournamentContent.visible = _btnTabCharacterGlobalTournament.tabbed;
      ...
      private function onClickTabCharacterGlobalTournament(param1:InteractionEvent) : void
      {
         _activeLeaderboard = 6;
         _btnTabCharacters.tabbed = false;
         _btnTabGuilds.tabbed = false;
         _btnTabGuildCompetition.tabbed = false;
         _btnTabMovies.tabbed = false;
         _btnTabCharacterGlobalTournament.tabbed = true;
         refreshContentButtons();
         var _loc2_:SymbolDialogLeaderboardGeneric = _vo as SymbolDialogLeaderboardGeneric;
         _loc2_.characterContent.visible = _btnTabCharacters.tabbed;
         _loc2_.guildContent.visible = _btnTabGuilds.tabbed;
         ...
         _loc2_.globalTournamentContent.visible = _btnTabCharacterGlobalTournament.tabbed;
         _btnScrollUp.content.y = -195;
         _characterGlobalTournamentContent.show();
         _loc2_.btnFilter.visible = false;
      }
      ...
      private function refreshContentButtons() : void
      {
         ...
         else if(_btnTabCharacterGlobalTournament.tabbed)
         {
            _btnViewTop.tooltip = LocText.current.text("dialog/leaderboard/button_top_ten_tooltip");
            _btnSearch.tooltip = LocText.current.text("dialog/leaderboard/button_search_tooltip");
            _btnViewPlayer.visible = true;
      ...
      private function scrollUp(param1:int, param2:Boolean) : void
      {
         ...
         {
            _characterGlobalTournamentContent.scrollUp(param1,param2);
         }
      }
      ...
      private function scrollDown(param1:int, param2:Boolean) : void
      {
         ...
         {
            _characterGlobalTournamentContent.scrollDown(param1,param2);
         }
      }
      ...
      private function onClickViewPlayer(param1:InteractionEvent) : void
      {
         ...
         {
            _loc2_ = _characterGlobalTournamentContent.currentCharacter.id;
            _loc3_ = _characterGlobalTournamentContent.currentCharacter.serverId;
         }
         else if(_btnTabGuildCompetition.tabbed)
         {
      ...
      private function onClickViewTop(param1:InteractionEvent) : void
      {
         ...
         {
            _characterGlobalTournamentContent.scrollToTop();
         }
      }
      ...
      private function onClickSearch(param1:InteractionEvent) : void
      {
         ...
         {
            _characterGlobalTournamentContent.search(_loc2_.inputSearch.text);
         }
      }
      ...
      private function refreshButtons() : void
      {
         ...
         else if(_btnTabCharacterGlobalTournament && _btnTabCharacterGlobalTournament.tabbed)
         {
            _btnViewPlayer.buttonEnabled = _characterGlobalTournamentContent.characterCount > 0;
            _btnViewTop.buttonEnabled = _characterGlobalTournamentContent.characterCount > 0;
            _btnSearch.buttonEnabled = _characterGlobalTournamentContent.characterCount > 0;
            _btnScrollUp.visible = _characterGlobalTournamentContent.characterCount > 10;
            _btnScrollDown.visible = _characterGlobalTournamentContent.characterCount > 10;
         }
      }
