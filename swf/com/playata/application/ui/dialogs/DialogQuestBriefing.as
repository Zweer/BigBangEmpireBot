package com.playata.application.ui.dialogs
{
   ...
   public class DialogQuestBriefing extends UiDialog
   {
      ...
      private function setCurrentData() : void
      {
         ...
         {
            if((_currentData as Quest).isTimeQuest)
            {
               _realContent.txtType.text = LocText.current.text("screen/quest/button_time_quest_tooltip");
            }
            else if((_currentData as Quest).isFightQuest)
            {
               _realContent.txtType.text = LocText.current.text("screen/quest/button_fight_quest_tooltip");
            }
            else
      ...
      private function handleRequests(param1:ActionRequestResponse) : void
      {
         ...
         switch(_loc4_)
         {
            case "startQuest":
               ...
               else if(param1.error == "errStartQuestActiveWorkFound")
               {
                  Environment.panelManager.showDialog(new UiInfoDialog(LocText.current.text("dialog/start_quest_active_work/title"),LocText.current.text("dialog/start_quest_active_work/text"),LocText.current.text("general/button_ok")));
               }
            ...
            case "startConventionShow":
               ...
               else if(param1.error == "errStartConventionShowActiveWorkFound")
               {
                  Environment.panelManager.showDialog(new UiInfoDialog(LocText.current.text("dialog/start_quest_active_work/title"),LocText.current.text("dialog/start_quest_active_work/text"),LocText.current.text("general/button_ok")));
               }
