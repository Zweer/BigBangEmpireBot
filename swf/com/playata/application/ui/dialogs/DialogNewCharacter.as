package com.playata.application.ui.dialogs
{
   ...
   public class DialogNewCharacter extends UiDialog
   {
      ...
      public function DialogNewCharacter(param1:Vector.<String>)
      {
         ...
         AppAssetUtil.setLocaleFlag(Environment.info.defaultLocale,_content.iconLocaleCurrentServer);
         ...
         var _loc4_:Vector.<String> = ServerInfo.getAvailableNewCharacterLocales(_usedServerIds);
         var _loc2_:String = _loc4_[0];
         if(_loc4_.indexOf(Environment.info.defaultLocale) != -1)
         {
            _loc2_ = Environment.info.defaultLocale;
         }
         var _loc3_:Vector.<String> = ServerInfo.getServersForNewCharacterLocale(_loc2_,_usedServerIds);
