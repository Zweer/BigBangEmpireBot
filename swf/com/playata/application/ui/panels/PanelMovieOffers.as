package com.playata.application.ui.panels
{
   ...
   public class PanelMovieOffers extends DefaultPanel
   {
      ...
      override public function show(param1:* = null) : void
      {
         ...
         {
            _loc2_.noOffersContent.discountHint.level.text = "";
            ...
            var _loc4_:* = true;
            _loc2_.noOffersContent.discountHint.caption.autoFontSize = _loc4_;
            _loc2_.noOffersContent.discountHint.level.autoFontSize = _loc4_;
            _loc2_.noOffersContent.discountHint.caption.x = -(_loc2_.noOffersContent.discountHint.level.width + _loc2_.noOffersContent.discountHint.caption.width + 2) * 0.5;
            _loc2_.noOffersContent.discountHint.level.x = _loc2_.noOffersContent.discountHint.caption.x + _loc2_.noOffersContent.discountHint.caption.width + 2;
