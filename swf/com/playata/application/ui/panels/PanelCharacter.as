package com.playata.application.ui.panels
{
   ...
   public class PanelCharacter extends DefaultPanel
   {
      ...
      private var _btnTitle:UiButton;
      ...
      override public function show(param1:* = null) : void
      {
         ...
         else
         {
            ...
            if(character == User.current.character)
            {
               ...
               {
                  ViewManager.instance.tutorialArrow.showTutorial(LocText.current.text("tutorial/movies_arrow_text"),"left_back","down",660 + LayoutUtil.deviceAdjustedWidthCorrection / 2,530 + LayoutUtil.deviceAdjustedHeightCorrection,1.5);
               }
      ...
      override public function refresh() : void
      {
         ...
         var _loc2_:SymbolPanelCharacterGeneric = _vo as SymbolPanelCharacterGeneric;
         var _loc1_:Character = User.current.character;
         _loc2_.infoBox.clickLayerAvatar.visible = _customCharacter == null && User.current.character.hasTutorialFlag("tutorial_finished");
         if(_customCharacter != null)
         {
         ...
         if(_btnTitle)
         {
            _loc2_.characterName.killTweens();
            _loc2_.characterName.removeAllFilters();
            if(_customCharacter == null && (Titles.instance.availableTitles(_loc1_).length > 0 || Marriages.instance.getMarriagesOfCharacterId(_loc1_.id).length > 0))
            {
               ...
               _loc2_.characterName.info.caption.text = _loc1_.newTitlesCount.toString();
               _loc2_.characterName.info.x = _loc2_.characterName.txtName.textWidth * 0.5 + 5;
               if(_loc1_.newTitlesCount > 0)
               {
                  _loc2_.characterName.info.visible = true;
                  _loc2_.characterName.tweenTo(1,{
                     "yoyo":true,
                     "repeat":-1,
                     "glowFilter":{
                        "color":16711908,
               ...
               {
                  _loc2_.characterName.info.visible = false;
                  _btnTitle.tooltip = "";
               }
            }
            else
         ...
         _loc2_.statsComparison.visible = _customCharacter != null;
         _loc2_.txtOwnStats.visible = _customCharacter != null;
         _ownStats.enableIncrease(false);
         _loc2_.infoBox.iconOnline.visible = _customCharacter != null && _customCharacter.isOnline;
         _loc2_.infoBox.txtOnline.visible = _customCharacter != null && _customCharacter.isOnline;
         _loc2_.infoBox.txtOnline.text = LocText.current.text("screen/character_overview/online_tooltip");
         _btnAttack.visible = _customCharacter != null && !_customCharacter.isDeleted;
         _loc2_.txtTimeToNextAttack.visible = !User.current.character.hasAvailableFreeDuel && _customCharacter != null;
         ...
         _loc2_.characterName.txtName.text = _loc1_.name;
         _loc2_.characterName.txtTitle.text = _loc1_.title;
         _loc2_.infoBox.enemyInformation.visible = !_loc1_.isMe;
         _loc2_.infoBox.iconPhotographer.visible = _loc1_.isMe;
         if(_loc1_.hasGuild)
         {
            if(!_loc1_.isMe)
            {
               _loc2_.infoBox.enemyInformation.txtGuildName.htmlText = "<a href=\'event:null\'>" + StringUtil.cutLength(_loc1_.guild.name,15) + "</a>";
               ...
               _loc2_.infoBox.enemyInformation.iconGuild.visible = false;
            }
            else
            {
               _loc2_.infoBox.txtGuildName.htmlText = "<a href=\'event:null\'>" + StringUtil.cutLength(_loc1_.guild.name,15) + "</a>";
               if(_loc1_.guild.name.length <= 15)
               {
               ...
               _loc2_.infoBox.iconGuild.visible = false;
               _guildEmblem.refresh(_loc1_.guild.emblemSettings);
            }
         }
         else if(_loc1_.isMe)
         {
            _loc2_.infoBox.txtGuildName.text = LocText.current.text("screen/character_overview/no_guild");
            _tooltipGuild.text = _loc2_.infoBox.txtGuildName.text;
            _loc2_.infoBox.iconGuild.visible = true;
            _loc2_.infoBox.guildEmblem.visible = false;
         }
         else
         {
            _loc2_.infoBox.enemyInformation.txtGuildName.text = LocText.current.text("screen/character_overview/no_guild");
            _tooltipGuildEnemy.text = _loc2_.infoBox.enemyInformation.txtGuildName.text;
            _loc2_.infoBox.enemyInformation.iconGuild.visible = true;
            _loc2_.infoBox.enemyInformation.guildEmblem.visible = false;
         }
         if(_customCharacter != null)
         {
            ...
            _loc2_.infoBox.iconHonor.visible = false;
            _loc2_.infoBox.iconGuild.visible = false;
            _loc2_.infoBox.iconFans.visible = false;
            _loc2_.infoBox.iconMovies.visible = false;
            _loc2_.infoBox.txtGuildName.visible = false;
            _loc2_.infoBox.txtHonor.visible = false;
            _loc2_.infoBox.txtFans.visible = false;
            _loc2_.infoBox.txtMovies.visible = false;
            _loc2_.infoBox.txtGuildName.visible = false;
            _loc2_.infoBox.guildEmblem.visible = false;
            _loc2_.infoBox.enemyInformation.txtHonor.text = LocText.current.formatHugeNumber(_loc1_.honor);
            _loc2_.infoBox.enemyInformation.txtLevel.text = String(_loc1_.level);
            _loc2_.infoBox.enemyInformation.txtFans.text = LocText.current.shortenHugeNumber(_loc1_.fansTotal);
            _loc2_.infoBox.enemyInformation.txtMovies.text = LocText.current.formatHugeNumber(_loc1_.moviesTotal);
         }
         else
         {
            _descriptionTooltip.text = LocText.current.text("screen/character/description_self_tooltip");
            _loc2_.infoBox.iconHonor.visible = true;
            _loc2_.infoBox.iconFans.visible = true;
            _loc2_.infoBox.iconMovies.visible = true;
            _loc2_.infoBox.txtHonor.visible = true;
            _loc2_.infoBox.txtGuildName.visible = true;
            _loc2_.infoBox.txtFans.visible = true;
            _loc2_.infoBox.txtMovies.visible = true;
            _loc2_.infoBox.txtHonor.text = LocText.current.formatHugeNumber(_loc1_.honor);
            _loc2_.infoBox.txtFans.text = LocText.current.shortenHugeNumber(_loc1_.fansTotal);
            _loc2_.infoBox.txtMovies.text = LocText.current.formatHugeNumber(_loc1_.moviesTotal);
         }
         _loc2_.infoBox.txtDescription.text = _loc1_.description;
         if(_loc2_.infoBox.txtDescription.textHeight >= _loc2_.infoBox.txtDescription.height)
         {
            _loc5_ = "";
            _loc3_ = 0;
            while(_loc3_ < 5)
            {
               _loc5_ = _loc5_ + _loc2_.infoBox.txtDescription.getLineText(_loc3_);
               _loc3_++;
            }
            _loc5_ = _loc5_ + ("... [" + LocText.current.text("screen/character/description/text_more") + "]");
            _loc2_.infoBox.txtDescription.text = _loc5_;
         }
         ...
         var _loc7_:Item = _loc1_.getItem("chest_item_id");
         if(_loc7_ && _loc7_.isOutfitItem && _loc1_.isChestItemShown)
         {
         ...
         _loc2_.infoBox.txtFriend.visible = AppEnvironment.appPlatform.isFriendbarSupported && User.current.showFriendbar && _customCharacter != null;
         _loc2_.infoBox.checkFriend.visible = _loc2_.infoBox.txtFriend.visible;
         _loc2_.infoBox.frameBackground.gotoAndStop(!!_loc2_.infoBox.checkFriend.visible?2:1);
         if(_loc2_.infoBox.txtFriend.visible)
         {
         ...
         var _loc4_:String = PanelDuels.getDuelResultTooltip(_loc1_.level,_loc1_.honor,_loc1_.totalStats);
         if(User.current.character.activeDuel)
         {
            _loc4_ = LocText.current.text("screen/character/button_attack/occupied_with_duel_tooltip");
         }
         _btnAttack.premiumTooltip = _loc4_;
         _btnAttack.nonPremiumTooltip = _loc4_;
         if(_customCharacter != null)
         {
      ...
      {
         Environment.panelManager.showDialog(new DialogMailCompose(_customCharacter.name));
      }
      
      private function onClickViewGoals(param1:InteractionEvent) : void
      {
         Environment.application.sendActionRequest("getCharacterGoals",{"character_id":_customCharacter.id},handleRequests);
      }
      ...
      private function loadGuild(param1:InteractionEvent = null) : void
      {
         ...
         Environment.application.sendActionRequest("getGuild",{"guild_id":_customCharacter.guildId},handleRequests);
      }
