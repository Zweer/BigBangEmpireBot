package com.playata.application.data.character
{
   ...
   public class Character extends DOCharacter implements ICharacterTooltipProvider
   {
      ...
      private var _newMessages:int = 0;
      ...
      public function openGoalValues(param1:Boolean = false, param2:int = 0, param3:Boolean = false, param4:Boolean = true) : Vector.<GoalValue>
      {
         var _loc5_:Vector.<GoalValue> = new Vector.<GoalValue>();
         var _loc11_:int = 0;
            ...
            if(!(param2 > 0 && _loc7_.category != param2))
            {
               if(_loc7_.identifier != "account_confirmed")
               {
                  if(!(_loc7_.identifier == "first_quest_resource_request_accepted" && !AppEnvironment.appPlatform.isResourceRequestAllowed))
                  {
                     ...
                     {
                        var _loc9_:int = 0;
                        var _loc8_:* = _loc7_.values;
                        for each(var _loc6_ in _loc7_.values)
                        {
                           if(!_loc6_.isCollected(this))
                           {
                              if(!(param1 && !_loc6_.isCollectable(this) && !_loc6_.isAvailable(this)))
                              {
                                 if(!(_loc7_.isHidden && !_loc6_.isCollectable(this)))
                                 {
                                    if(param3)
                                    {
                                       if(!UiGoalFilter.isAllowed(_loc6_,this))
                                       {
                                          continue;
                                       }
                                    }
         ...
         if(param4)
         {
            _loc5_.sort(sortByPosition);
         }
         return _loc5_;
      }
      
      public function finishedGoalValues(param1:int = 0) : Vector.<GoalValue>
      {
         var _loc2_:Vector.<GoalValue> = new Vector.<GoalValue>();
         var _loc8_:int = 0;
      ...
      private function sortByPosition(param1:GoalValue, param2:GoalValue) : int
      {
         var _loc3_:Boolean = param1.isCollectable(this);
         var _loc4_:Boolean = param2.isCollectable(this);
         if(_loc3_ && !_loc4_)
         {
            return -1;
         }
      ...
      public function get pinnedStorygoal() : GoalValue
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:* = null;
         if(hasData("storygoal") && storygoal != "")
         {
            _loc4_ = storygoal.split(";");
            if(_loc4_.length == 2)
            {
               _loc2_ = _loc4_[0];
               ...
               {
                  if(_loc3_.identifier == _loc2_)
                  {
                     var _loc8_:int = 0;
                     var _loc7_:* = _loc3_.values;
                     for each(_loc1_ in _loc3_.values)
                     {
                        if(_loc1_.value == _loc5_)
                        {
                           _loc6_ = _loc1_;
                           break loop0;
                        }
         ...
         if(_loc6_ && !_loc6_.isCollected(this) && (_loc6_.isAvailable(this) || _loc6_.isCollectable(this)))
         {
            return _loc6_;
         }
         return null;
      ...
      public function get newMessages() : int
      {
         return _newMessages;
      }
      
      public function get totalNewMessages() : int
      {
         var _loc1_:int = newMessages;
         if(AppEnvironment.appPlatform.isResourceRequestAllowed)
         {
            _loc1_ = _loc1_ + pendingResourceRequests;
         }
         return _loc1_;
      }
      
      public function set newMessages(param1:int) : void
      {
         if(param1 > _newMessages)
         {
      ...
      {
         return CConstant.slotmachine_max_daily_spins - slotmachineSpinCount;
      }
