package com.playata.application.data.constants
{
   ...
   public class CConstant
   {
      ...
      public static function get movie_vote_chance_time() : int
      {
         return Constants.current.getInt("movie_vote_chance_time");
      }
      
      public static function get movie_vote_chance_fight() : int
      {
         return Constants.current.getInt("movie_vote_chance_fight");
      }
      
      public static function get movie_vote_chance_stat() : int
      {
         return Constants.current.getInt("movie_vote_chance_stat");
      }
      
      public static function get movie_vote_chance_short() : int
      {
         return Constants.current.getInt("movie_vote_chance_short");
      }
      
      public static function get movie_vote_chance_medium() : int
      {
         return Constants.current.getInt("movie_vote_chance_medium");
      }
      
      public static function get movie_vote_chance_long() : int
      {
         return Constants.current.getInt("movie_vote_chance_long");
      }
