         ...
         while(_loc12_ > 0)
         {
            ...
            else
            {
               ...
               while(_loc14_.indexOf(_loc19_) != -1)
               {
                  ...
                  _loc5_ = parseInt(rest[_loc12_ - 1].toString().replace(text("base/numbers/comma_separator"),"").replace(text("base/numbers/thousands_separator"),""));
                  _loc21_ = rest[_loc12_ - 1].toString().replace(text("base/numbers/comma_separator"),".").replace(text("base/numbers/thousands_separator"),"");
