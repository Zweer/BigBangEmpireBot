package starling.text
{
   ...
   class MiniBitmapFont
   {
      ...
      public static function get texture() : Texture
      {
         ...
         var format:String = "bgraPacked4444";
      ...
      {
         var _loc4_:int = 0;
         var _loc2_:BitmapData = new BitmapData(128,64);
         var _loc3_:ByteArray = new ByteArray();
         var _loc1_:int = BITMAP_DATA.length;
         _loc4_ = 0;
         while(_loc4_ < _loc1_)
         {
         ...
         _loc3_.uncompress();
         _loc2_.setPixels(new Rectangle(0,0,128,64),_loc3_);
         _loc3_.clear();
         return _loc2_;
      }
