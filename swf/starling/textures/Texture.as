package starling.textures
{
   ...
   public class Texture
   {
      ...
      public static function set asyncBitmapUploadSupported(param1:Boolean) : void
      {
         ConcreteRectangleTexture.asyncSupported = param1;
         ConcretePotTexture.asyncSupported = param1;
      }
