package starling.utils
{
   ...
   public class AssetManager extends EventDispatcher
   {
      ...
      public function dispose() : void
      {
         ...
         var _loc13_:int = 0;
         var _loc12_:* = _byteArrays;
         for each(var _loc4_ in _byteArrays)
         {
            _loc4_.clear();
         }
         var _loc15_:int = 0;
         var _loc14_:* = _bitmapFonts;
      ...
      public function loadQueue(param1:Function) : void
      {
         ...
         processXml = function(param1:int):void
         {
            ...
            {
               _loc6_ = getName(_loc5_.pages.page.@file.toString());
               _loc2_ = _loc6_;
               _loc4_ = getTexture(_loc6_);
               if(_loc4_)
               {
